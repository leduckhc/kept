...
- [x] **Auto Labels (rule-based)** — User-defined rules that auto-apply labels on incoming mail (e.g. "from:@github.com → Dev", "subject:invoice → Finance"). Client-side filter on sync. No AI needed. Done (f40f879).
