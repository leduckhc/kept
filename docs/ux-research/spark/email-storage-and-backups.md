...
At the same time, such unique features as [Teams](https://sparkmailapp.com/sparkdesktop/spark-for-teams) and [Send Later](https://sparkmailapp.com/sending-emails/schedule-an-email-to-send-later) require the support of our servers and your emails corresponding to these features are safely stored there in an encrypted form.

If you have any questions or concerns about your personal data storage, please check out our [Privacy section](https://sparkmailapp.com/sparkdesktop/privacy-data).