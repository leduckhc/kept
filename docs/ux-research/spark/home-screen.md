...
**Note:** The Home Screen is a part of the Spark paid plans' functionality for Mac and Windows. To learn more about available features, please visit our [Pricing page](https://sparkmailapp.com/plans-comparison).

This article will discuss how to set the Home Screen according to what works best for you.

Jump to:

* [Home Screen Overview](#home-screen-overview-0)
* [Access the Home Screen settings](#access-the-home-screen-settings-4)
* [Show Home Screen after 15 minutes of inactivity](#show-home-screen-after-15-minutes-of-inactivity-5)
* [Set Email Focus Schedule](#set-email-focus-schedule-6)
* [Disable Home Screen](#disable-home-screen-7)
...
“Checking email less frequently reduces stress and improves well-being,” - the University of British Columbia.
...
1. Open Spark Desktop.
2. Click the phrase to the right of the search icon in the upper right.
3. Choose any of the following settings:
...
1. Click **Spark** **Desktop**.
2. Select **Settings**.
3. Switch to the **Home Screen** section.

## Show Home Screen After 15 minutes of inactivity

To access this setting, open [Spark Settings](https://sparkmailapp.com/1442243-how-to-find-spark-settings) > **Home Screen**. The setting automatically enables Home Screen when Spark is inactive for some time, except when you compose or view an email.
...
Remember the “Next email session is scheduled to…” phrase on the Spark Home Screen? There’s a manageable schedule standing behind. Sticking to a schedule minimizes the number of context switches as well as time spent inside the app, which allows you to preserve your mental energy and get more time to focus on what is important outside of your inbox.

To access this setting, open [Spark Settings](https://sparkmailapp.com/1442243-how-to-find-spark-settings) > Home Screen > Set Email Focus Schedule.

**Tip:**By default, three times per day are set for working with mail.
...
1. Open [Spark Settings](https://sparkmailapp.com/questions/1442243-how-to-find-spark-settings) > Home Screen.
2. Disable the **Enable Home Screen** toggle.